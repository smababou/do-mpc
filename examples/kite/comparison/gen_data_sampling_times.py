...
for ts in sampling_times:
    ...
    for i in range(offset, offset + n_batches):
        ...
        while (configuration_1.simulator.t0_sim + configuration_1.simulator.t_step_simulator < configuration_1.optimizer.t_end):
            ...
            x_lb = NP.array([0.2, -1.1,-3.1])
            x_ub = NP.array([0.9, 1.1, 3.1])
        ...
        data_do_mpc.export_for_learning(configuration_1, "results_sampling_time/data_batch_NN_" + str(ts) + "_" + str(i))
