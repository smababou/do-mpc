...
print("Tension:\tMPC\t%8.4f,\tNN\t%8.4f" % (NP.mean(TF_MPC), NP.mean(TF_NN)))
print("V (mean):\tMPC\t%8.4f,\tNN\t%8.4f" % (NP.mean(mean_viol_MPC), NP.mean(mean_viol_NN)))
print("V (max):\tMPC\t%8.4f,\tNN\t%8.4f" % (NP.max(max_viol_MPC), NP.max(max_viol_NN)))
