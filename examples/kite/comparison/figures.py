...
for i in range(n_batches):
    ...
    if nv > 0:
        ...
        if not mean_all:
            ...
            v_mean = NP.sum(v_array)/data_MPC[i].shape[0]
    else:
        v_max = 0.0
        v_mean = 0.0
    ...
    if nv > 0:
        ...
        if not mean_all:
            ...
            v_mean = NP.sum(v_array)/data_MPC_P[i].shape[0]
    else:
        v_max = 0.0
        v_mean = 0.0
    ...
    if nv > 0:
        ...
        if not mean_all:
            ...
            v_mean = NP.sum(v_array)/data_NN[i].shape[0]
    else:
        v_max = 0.0
        v_mean = 0.0
    ...
    if nv > 0:
        ...
        if not mean_all:
            ...
            v_mean = NP.sum(v_array)/data_NN_P[i].shape[0]
    else:
        v_max = 0.0
        v_mean = 0.0
...
TF_MPC_P = NP.vstack(TF_MPC_P)
mean_viol_MPC_P = NP.vstack(mean_viol_MPC_P)
max_viol_MPC_P = NP.vstack(max_viol_MPC_P)
n_viol_MPC_P = NP.vstack(n_viol_MPC_P)

TF_NN_P = NP.vstack(TF_NN_P)
mean_viol_NN_P = NP.vstack(mean_viol_NN_P)
max_viol_NN_P = NP.vstack(max_viol_NN_P)
n_viol_NN_P = NP.vstack(n_viol_NN_P)


print("\t\tMPC \t\tNN \t\tMPC_P \t\tNN_P")
