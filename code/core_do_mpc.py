...
class ocp:
    ...
    def __init__(self, param_dict, *opt):
        ...
        x0 = param_dict["x0"]
        z0 = param_dict["z0"]
        self.x0 = vertcat(x0,z0)#param_dict["x0"]
        ...
        self.x_lb = vertcat(x_lb,z_lb)#param_dict["x_lb"]
        self.x_ub = vertcat(x_ub,z_ub)#param_dict["x_ub"]
        ...
        self.x_scaling = vertcat(x_scaling,z_scaling)#param_dict["x_scaling"]
